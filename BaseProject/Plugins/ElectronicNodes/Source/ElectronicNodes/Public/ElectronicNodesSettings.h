...
public:
	...
	/* Hot patch hardcoded Unreal functions (only available on Windows) to make some more features available. Default: true */
	UPROPERTY(config, EditAnywhere, Category = "Activation|Schema", meta = (EditCondition = "MasterActivate"))
	...
	/* Activate Electronic Nodes on Behavior Tree. Default: true */
	UPROPERTY(config, EditAnywhere, Category = "Activation|Schema", meta = (EditCondition = "MasterActivate && UseHotPatch"))
	...
	/* Activate Electronic Nodes everywhere. Default: false */
